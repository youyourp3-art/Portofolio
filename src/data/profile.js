...
export const nav = [
  ...
  { id: "etude-cas", num: "08", label: { fr: "Étude de cas — Aïn Bénian", de: "Fallstudie — Aïn Bénian" } },
  { id: "admin", num: "09", label: { fr: "Administration", de: "Administration" } },
  { id: "contact", num: "10", label: { fr: "Contact", de: "Kontakt" } },
  {
    id: "admin-panel",
    num: "11",
